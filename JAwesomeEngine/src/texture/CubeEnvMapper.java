...
public class CubeEnvMapper {
	...
	public CubeEnvMapper(StandardGame game, Vector3f pos) {
		top = new FrameBufferObject(game, pos, new Vector3f(0, 1, 0),
				new Vector3f(0, 0, 1));
		bottom = new FrameBufferObject(game, pos, new Vector3f(0, -1, 0),
				new Vector3f(0, 0, -1));
		front = new FrameBufferObject(game, pos, new Vector3f(0, 0, 1),
				new Vector3f(0, 1, 0));
		back = new FrameBufferObject(game, pos, new Vector3f(0, 0, -1),
				new Vector3f(0, 1, 0));
		right = new FrameBufferObject(game, pos, new Vector3f(1, 0, 0),
				new Vector3f(0, 1, 0));
		left = new FrameBufferObject(game, pos, new Vector3f(-1, 0, 0),
				new Vector3f(0, 1, 0));
	}
