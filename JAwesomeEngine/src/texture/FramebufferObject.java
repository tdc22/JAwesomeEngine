...
public class FramebufferObject {
	...
	private void init(ViewProjection render, int width, int height,
			int samples, Camera camera, Texture colorbuffer,
			ViewFrustum frustum, boolean renderColor, boolean renderDepth,
			boolean renderColorToTexture, boolean renderDepthToTexture) {
		this.render = render;
		this.width = width;
		this.height = height;
