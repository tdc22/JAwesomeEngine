...
public class IsoSphere extends ShapedObject implements SphereStructure {
	...
	public IsoSphere(float x, float y, float z, float radius, int divisionmethod, int subdivisions) {
		super();
		translateTo(x, y, z);
		init(radius, divisionmethod, subdivisions);
	}
	
	public IsoSphere(Vector3f pos, float radius, int divisionmethod, int subdivisions) {
		super();
		translateTo(pos);
		init(radius, divisionmethod, subdivisions);
	}
	
	private void init(float radius, int divisionmethod, int subdivisions) {
		this.radius = radius;
