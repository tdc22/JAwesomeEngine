...
public class QuaternionTest {
	public static void main(String[] args) {
		...
		rot1.rotate(Math.toRadians(90), new Vector3f(1, 0, 0));
		...
		rot1.setIdentity();
		rot1.rotate(Math.toRadians(90), new Vector3f(0, 1, 0));
		System.out.println(rot1);
		System.out.println(rot1.toMatrix());
		System.out.println("------------");
		m = new Matrix4f();
		...
		rot1.rotate(Math.toRadians(60), new Vector3f(0, 1, 0));
		System.out.println(rot1);
		System.out.println(rot1.toMatrix());
		System.out.println("------------");
		m.rotate(Math.toRadians(60), new Vector3f(0, 1, 0));
		System.out.println(m.getSubMatrix());
		System.out.println();

		System.out.println("Z-Axis:");
		rot1.setIdentity();
		rot1.rotate(Math.toRadians(90), new Vector3f(0, 0, 1));
		System.out.println(rot1);
		System.out.println(rot1.toMatrix());
		System.out.println("------------");
		m = new Matrix4f();
		m.rotate(Math.toRadians(90), new Vector3f(0, 0, 1));
		System.out.println(m.getSubMatrix());
		System.out.println();
		...
		threeangles.rotate(Math.toRadians(60), new Vector3f(1.0f, 0.0f, 0.0f));
		System.out.println("1: " + threeangles);
		threeangles.rotate(Math.toRadians(40), new Vector3f(0.0f, 1.0f, 0.0f));
		System.out.println("2: " + threeangles);
		threeangles.rotate(Math.toRadians(20), new Vector3f(0.0f, 0.0f, 1.0f));
