...
public class Particle extends StandardGame {
	...
	public void init() {
		...
		particlesource = new SimpleParticleSource(new Vector3f(0, 0, 0),
				new Vector3f(), new Vector3f(0, 0, 0), new Vector3f(360, 360,
						360), 0.001f, 0.002f, 0.3f, 0.3f, 3000, 3500, 1f, cam,
				true);
