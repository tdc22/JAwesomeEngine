...
public class ManifoldVisualization extends ShapedObject2 {
	ManifoldVisualization(CollisionManifold<Vector2f, Complexf> cm) {
		...
		Vector2f tangent1 = VecMath.addition(center1, VecMath.scale(cm.getContactTangentA(), cm.getPenetrationDepth()));
		Vector2f tangent2 = VecMath.addition(center2, VecMath.scale(cm.getContactTangentB(), cm.getPenetrationDepth()));
