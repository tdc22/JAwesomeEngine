...
public class SupportFunctionTest extends StandardGame {
	...
	public void init() {
		...
		support1 = new SupportDifferenceObject2(q, rb1.getCollisionShapes()
				.get(0), q2, rb2);
		support2 = new SupportDifferenceObject2(q, rb1.getCollisionShapes()
				.get(0), c1, rb3);
		support11 = new SupportDifferenceObject2(c, rb1.getCollisionShapes()
				.get(1), q2, rb2);
		support21 = new SupportDifferenceObject2(c, rb1.getCollisionShapes()
				.get(1), c1, rb3);
