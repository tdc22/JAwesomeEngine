...
public abstract class BaseObject<L extends Vector, A extends Rotation> {
	...
	// rotation.rotate(new Quaternionf(comp.getRealf(), 0, 0,
	// comp.getImaginaryf()));
	// }
	//
	// /**
	...
	// */
	// public void setRotationCenter(float centerx, float centery, float
	// centerz) {
	...
	// scale.x, 0, mat[1][0] * scale.y,
	// mat[1][1] * scale.y, mat[1][2] * scale.y, 0, mat[2][0] * scale.z,
	// mat[2][1] * scale.z,
	// mat[2][2] * scale.z, 0, translation.getXf(), translation.getYf(),
	// translation.getZf(), 1);
	// }
}