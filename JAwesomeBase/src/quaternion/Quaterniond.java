...
public class Quaterniond extends Quaternion {
	...
	public void rotate(double q0, double q1, double q2, double q3) {
		double tq1 = this.q0 * q1 + this.q1 * q0 + this.q2 * q3 - this.q3 * q2;
		double tq2 = this.q0 * q2 + this.q2 * q0 + this.q3 * q1 - this.q1 * q3;
		double tq3 = this.q0 * q3 + this.q3 * q0 + this.q1 * q2 - this.q2 * q1;
