...
public class DistanceConstraint2Old {
	...
	public DistanceConstraint2Old(RigidBody<Vector2f, Vector1f, Complexf, Matrix1f> bodyA, RigidBody<Vector2f, Vector1f, Complexf, Matrix1f> bodyB, Vector2f anchorA, Vector2f anchorB, float length) {
		this.bodyA = bodyA;
		this.bodyB = bodyB;
