...
public abstract class GilbertJohnsonKeerthi<L extends Vector> implements Narrowphase<L> {
	final List<L> simplex;
	L direction;
	ManifoldGenerator<L> manifoldgeneration;

	public GilbertJohnsonKeerthi(ManifoldGenerator<L> manifoldgeneration, int maxSimplexSize) {
