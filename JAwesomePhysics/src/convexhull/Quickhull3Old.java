			...
			while (currT < faces.size() && iterations > 0) {
				...
				if (p != -1) {
					...
					for (int i = 0; i < faces.size(); i++) {
						...
						// Integer[] adjs = adjacentsMap.get(i); FALSCH, vertex,
						// nicht facebasiert
